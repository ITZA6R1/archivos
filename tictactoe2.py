...
def escribir():
	...
	es_valido = False
	if turno%2 == 0:
		print("Turno de "+nombreJugador+" ("+playerFicha+")")
		while es_valido == False:
			colinp = int(input("Marca la columna (1-"+str(col)+"): "))-1
			rowinp = int(input("Marca la fila (1-"+str(row)+"): "))-1
		...
		if numJugadores == 2:
			print("Turno de "+nombreJugador2+" ("+compFicha+")")
			while es_valido == False:
				colinp = int(input("Marca la columna (1-"+str(col)+"): "))-1
				rowinp = int(input("Marca la fila (1-"+str(row)+"): "))-1
				if tablero[rowinp][colinp] == " ":
